          ...
          <v-row class="pa-5">
            ...
            >
              <div>
                ...
                ><v-card-subtitle class="pa-0 text-md-right font-italic red--text" v-if="apotek.obat.toLowerCase() != 'multivitamin'"
                  >{{apotek.obat.toLowerCase() == 'multivitamin' ? 'Tidak perlu resep dokter' : 'Perlu resep dokter'}}</v-card-subtitle
                >
